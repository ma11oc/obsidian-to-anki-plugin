...
export default class ObsidianToAnki extends Plugin {
  ...
  async onload () {
    console.log('loading ObsidianToAnki...')
    ...
    this.addRibbonIcon('anki', 'ObsidianToAnki - Scan Vault', async () => {
  ...
  async onunload () {
    console.log('Saving settings for ObsidianToAnki...')
    this.saveAllData()
    console.log('Unloading ObsidianToAnki...')
  }
}
